...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.88\textwidth]{paper/figures/fig_error_rank}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.88\textwidth]{paper/figures/fig_cumvar_comparison}
    \caption{Cumulative variance analysis. K achieves significantly higher cumvar at low ranks than V, revealing the compression asymmetry. At rank 8, Mistral K captures 0.9413 vs V at 0.5995, a gap of 0.342 that quantifies the Value bottleneck.}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{paper/figures/fig_method_d_comparison}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\textwidth]{paper/figures/fig_cumvar_comparison}
    \caption{Key vs. Value information asymmetry analysis. K captures substantially more variance at low ranks than V across both Mistral-7B and Gemma-2-9B.}
...
\FloatBarrier
\section{Appendix: Extended Evaluation}
\label{sec:appendix}

\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{paper/figures/appendix_pareto_frontier}
    \caption{Pareto frontier analysis across four attention distributions: clustered, random, skewed, and uniform. ACCORD-KV consistently achieves the best trade-off between memory usage and attention error, marked by the orange star.}
    \label{fig:appendix_pareto}
\end{figure}

\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{paper/figures/appendix_method_d_heatmap}
    \caption{Method D ablation: attention reconstruction error (normalised) across clustering algorithms (KMeans, GMM, Agglomerative, Birch) and number of clusters $k \in \{2,4,8,16,32\}$ at fixed rank=8. Darker cells indicate higher error. The boxed region highlights where clustering provides the largest advantage.}
